...
for m in range(5,11):
    ...
    temp_obc_south = np.reshape(temp_obc_south,(1,400,80))
    ...
    salt_obc_north = np.reshape(salt_obc_north,(1,400,80))
    ...
    salt_obc_south = np.reshape(salt_obc_south,(1,400,80))
    ...
    vvel_obc_north = np.reshape(vvel_obc_north,(1,400,80))
    ...
    vvel_obc_south = np.reshape(vvel_obc_south,(1,400,80))
    ...
    temp = ncfile.createVariable('temp',np.float32,('z','xb','y'))
    salt = ncfile.createVariable('salt',np.float32,('z','xb','y'))
    vvel = ncfile.createVariable('vvel',np.float32,('z','xb','y'))

    temp[:,:,:]  = np.flip(temp_obc_north[:,:,:],0)
    salt[:,:,:]  = np.flip(salt_obc_north[:,:,:],0)
    vvel[:,:,:]  = np.flip(vvel_obc_north[:,:,:],0)
    ...
    temp[:,:,:]  = np.flip(temp_obc_south[:,:,:])
    salt[:,:,:]  = np.flip(salt_obc_south[:,:,:])
    vvel[:,:,:]  = np.flip(vvel_obc_south[:,:,:])
